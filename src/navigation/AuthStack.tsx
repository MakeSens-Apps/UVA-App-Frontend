...
export function AuthStack({ route }: AuthStackProps = {}): React.JSX.Element {
  ...
  return (
    ...
    >
      ...
      <Stack.Screen
        name="SetPhoneRegister"
        component={SetPhoneRegisterScreen}
      />
      <Stack.Screen
        name="ProjectVinculation"
        component={ProjectVinculationScreen}
      />
      <Stack.Screen name="ValidateProject" component={ValidateProjectScreen} />
      <Stack.Screen
        name="ProjectVinculationDone"
        component={ProjectVinculationDoneScreen}
      />
      <Stack.Screen
