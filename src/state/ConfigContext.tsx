...
export function ConfigProvider({
  ...
  const [configMeasurement, setConfigMeasurement] =
  ...
  const getConfigurationApp =
    useCallback(async (): Promise<ConfigModel | null> => {
  ...
  const getConfigurationMeasurement =
    useCallback(async (): Promise<MeasurementModel | null> => {
  ...
  const getConfigurationColors =
    useCallback(async (): Promise<ColorsModel | null> => {
