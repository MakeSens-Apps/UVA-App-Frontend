...
>;
export const createGamificationEvent =
  /* GraphQL */ `mutation CreateGamificationEvent(
...
` as GeneratedMutation<
  ...
  >;
export const updateGamificationEvent =
  /* GraphQL */ `mutation UpdateGamificationEvent(
...
` as GeneratedMutation<
  ...
  >;
export const deleteGamificationEvent =
  /* GraphQL */ `mutation DeleteGamificationEvent(
