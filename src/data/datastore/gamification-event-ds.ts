/**
 * B04 — GamificationEventDSService
 * Ported from: src/app/core/services/storage/datastore/gamification-event-ds.service.ts
 ...
 *
 * Static methods preserved as-is (portability-matrix §4.1 — static pattern allowed).
 */
