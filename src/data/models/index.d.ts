...
export declare type RACIMO = LazyLoading extends LazyLoadingDisabled
  ? EagerRACIMO
  : LazyRACIMO;
...
export declare const RACIMO: (new (init: ModelInit<RACIMO>) => RACIMO) & {
  copyOf(
    source: RACIMO,
    mutator: (draft: MutableModel<RACIMO>) => MutableModel<RACIMO> | void,
  ): RACIMO;
};
...
export declare type Measurement = LazyLoading extends LazyLoadingDisabled
  ? EagerMeasurement
  : LazyMeasurement;

export declare const Measurement: (new (
  init: ModelInit<Measurement>,
) => Measurement) & {
  copyOf(
    source: Measurement,
    mutator: (
      draft: MutableModel<Measurement>,
    ) => MutableModel<Measurement> | void,
  ): Measurement;
};
...
export declare type UserProgress = LazyLoading extends LazyLoadingDisabled
  ? EagerUserProgress
  : LazyUserProgress;

export declare const UserProgress: (new (
  init: ModelInit<UserProgress>,
) => UserProgress) & {
  copyOf(
    source: UserProgress,
    mutator: (
      draft: MutableModel<UserProgress>,
    ) => MutableModel<UserProgress> | void,
  ): UserProgress;
};
...
export declare type GamificationEvent = LazyLoading extends LazyLoadingDisabled
  ? EagerGamificationEvent
  : LazyGamificationEvent;

export declare const GamificationEvent: (new (
  init: ModelInit<GamificationEvent>,
) => GamificationEvent) & {
  copyOf(
    source: GamificationEvent,
    mutator: (
      draft: MutableModel<GamificationEvent>,
    ) => MutableModel<GamificationEvent> | void,
  ): GamificationEvent;
};
...
export declare type AppUsageEvent = LazyLoading extends LazyLoadingDisabled
  ? EagerAppUsageEvent
  : LazyAppUsageEvent;

export declare const AppUsageEvent: (new (
  init: ModelInit<AppUsageEvent>,
) => AppUsageEvent) & {
  copyOf(
    source: AppUsageEvent,
    mutator: (
      draft: MutableModel<AppUsageEvent>,
    ) => MutableModel<AppUsageEvent> | void,
  ): AppUsageEvent;
};
...
export declare type UVA = LazyLoading extends LazyLoadingDisabled
  ? EagerUVA
  : LazyUVA;
...
export declare const UVA: (new (init: ModelInit<UVA>) => UVA) & {
  copyOf(
    source: UVA,
    mutator: (draft: MutableModel<UVA>) => MutableModel<UVA> | void,
  ): UVA;
};
