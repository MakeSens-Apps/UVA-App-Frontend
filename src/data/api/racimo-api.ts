/**
 * B04 — RacimoAPIService
 * Ported from: src/app/core/services/api/racimo-api.service.ts
...
import { getRACIMO, listRACIMOS } from '@/data/graphql/queries';
import {
  GetRACIMOQuery,
...
export const racimoAPIService = new RacimoAPIService();
