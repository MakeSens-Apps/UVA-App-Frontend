/**
 * B04 — GamificationAlertsService
 * Ported from: src/app/core/services/view/gamification/gamification-alerts.service.ts
 * Classification: Minor adaptation
 * Changes:
 *   - Removed @Injectable({ providedIn: 'root' }) — static methods (same as original)
 *   - Import paths updated to mobile/ structure
 *
 * B07 will import and test this when porting gamification.service (full suite).
 */

import { SortDirection } from '@aws-amplify/datastore';
import { GamificationEvent } from '@/data/models';
import { GamificationEventDSService } from '@/data/datastore/gamification-event-ds';
import {
  EventData,
  eventMessages,
