/**
 * B04 — GamificationAlertsTypes (catalogue + validation)
 * Ported from: src/app/core/services/view/gamification/gamification-alerts-types.service.ts
 * Classification: Reusable as-is
 * Changes:
 *   - No @Injectable decorator (was already not using Angular DI)
 *   - File renamed: gamification-alerts-types.service.ts → gamification-alerts-types.ts
 *   - Import path only
 *
 * Contains: ~135 Spanish-language messages (ES), type definitions, validateEventData.
 * B07 will import this when porting gamification.service and gamification-alerts.service.
 */
