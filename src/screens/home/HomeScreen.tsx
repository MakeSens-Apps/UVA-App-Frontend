...
export function HomeScreen({ navigation }: Props): React.JSX.Element {
  ...
  const [completeTask, setCompleteTask] = useState<CompletedTask | undefined>(
    undefined,
  );
  ...
  async function setNotifications(): Promise<void> {
    const enableNotifications =
      await localRemindersService.getEnableNotifications();
    if (enableNotifications) {
  ...
  const seedValue =
    userProgress === undefined ? null : (userProgress?.Seed ?? 0);
      ...
      >
        <View style={styles.modalContent} testID="modal-days-question">
          <View style={styles.modalNavRow}>
            ...
            >
              <Text
                style={[styles.backArrow, { color: theme.colors.blue[900] }]}
              >
                ←
              </Text>
            </Pressable>
          ...
          <View style={styles.textCard}>
            <Text style={[styles.modalText, { color: theme.colors.blue[900] }]}>
              En el siguiente{' '}
              <Text style={styles.modalTextStrong}>ejemplo</Text> se muestran
              dos días de racha:
            </Text>
      ...
      >
        ...
        <View style={styles.modalContent} testID="modal-token">
          ...
          <View style={styles.tokenCard}>
            <Text
              style={[
                styles.modalTextCentered,
                { color: theme.colors.blue[900] },
              ]}
            >
              Cada día que cumplas{' '}
              <Text style={styles.modalTextStrong}>
                con todos tus registros
              </Text>{' '}
              ganas dos semillas.
            </Text>
            <View style={styles.seedCountRow}>
              <Text
                style={[styles.modalBig, { color: theme.colors.blue[900] }]}
              >
                +2
              </Text>
          ...
          <View style={styles.tokenCard}>
            ...
            >
              Los días que{' '}
              <Text style={styles.modalTextStrong}>cumplas con algunos</Text>{' '}
          ...
          <View style={styles.tokenCard}>
            ...
            >
              Si cumples{' '}
              <Text style={styles.modalTextStrong}>con 7 días de racha </Text>
              ganas{' '}
              <Text style={styles.modalTextStrong}>
                3 semillas adicionales.
              </Text>
            </Text>
            <View style={styles.seedCountRow}>
              <Text
      ...
      >
        <View style={styles.modalNavRow}>
          <Pressable
            ...
            accessibilityRole="button"
          >
            <Text style={[styles.backArrow, { color: theme.colors.blue[900] }]}>
              ←
            </Text>
          </Pressable>
          <Pressable
        ...
        <View style={styles.modalContent} testID="modal-token-2">
          ...
          <View style={styles.tokenCard}>
            ...
            >
              Al finalizar el <Text style={styles.modalTextStrong}>mes</Text> la
              cantidad de tus semillas{' '}
              <Text style={styles.modalTextStrong}>germinará</Text> de esta
              manera:
            </Text>
          </View>
          ...
          <View style={styles.tokenCard}>
            ...
            >
              De 0 a 10 semillas <Text style={styles.modalTextStrong}>No</Text>{' '}
              alcanza a germinar{' '}
              <Text style={styles.modalTextStrong}>nada</Text> 😒
            </Text>
          </View>
