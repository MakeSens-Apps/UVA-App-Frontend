...
export function PersonalInfoScreen({ navigation }: Props): React.JSX.Element {
  ...
  const onSubmit = useCallback(async (): Promise<boolean> => {
    ...
    if (pValid && lValid) {
      ...
      Alert.alert(
        'Error',
        'Para guardar todos los datos deben ser completados.',
      );
      return false;
    }
  }, [personalForm, locationForm]);
  ...
  const getFieldBorderColor = useCallback(
    (fieldKey: string, disabled?: boolean): string => {
      ...
      if (isEditable && focusedField === fieldKey)
  ...
  return (
    <View style={styles.root}>
                      ...
                      <View
                        style={[
                          styles.inputContainer,
                          {
                            ...
                            borderColor: getFieldBorderColor(field.key),
                          },
                        ]}
                      >
                        <TextInput
                    ...
                    render={({ field: f }) => (
                      <View
                        style={[
                          ...
                          {
                            backgroundColor: fieldBg,
                            borderColor: getFieldBorderColor('latitude'),
                          },
                        ]}
                      >
                        <TextInput
                    ...
                    render={({ field: f }) => (
                      <View
                        style={[
                          ...
                          {
                            backgroundColor: fieldBg,
                            borderColor: getFieldBorderColor('longitude'),
                          },
                        ]}
                      >
                        <TextInput
                  ...
                  render={({ field: f }) => (
                    <View
                      style={[
                        ...
                        {
                          backgroundColor: fieldBg,
                          borderColor: getFieldBorderColor('altitude'),
                        },
                      ]}
                    >
                      <TextInput
      ...
      <UvaBottomSheet ref={deleteModalRef} enablePanDownToClose>
        <View style={styles.deleteModal}>
          <View style={styles.deleteCard}>
            ...
            >
              Al <Text style={styles.strongText}>eliminar</Text> tu cuenta{' '}
              <Text style={styles.strongText}>perderás</Text> todos tus{' '}
              <Text style={styles.strongText}>datos registrados</Text> hasta el
              momento, sin embargo, estos datos se mantendrán en nuestra base de
              datos.
            </Text>
          </View>
          <View style={styles.deleteCard}>
      ...
      <UvaBottomSheet ref={deleteModal2Ref} enablePanDownToClose>
        <View style={styles.deleteModal}>
          <View style={styles.deleteCard}>
            <Text
              style={[
            ...
            >
              Para <Text style={styles.strongText}>eliminar</Text> tu cuenta por
