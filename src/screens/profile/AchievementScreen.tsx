  ...
  return (
    <View style={styles.root}>
      ...
      >
        ...
        >
          <Text
            style={[styles.fabText, { fontFamily: fontFamilyForWeight('500') }]}
          >
            ¿Dudas?
          </Text>
        </TouchableOpacity>
        ...
        >
          <View style={styles.modalContent}>
            ...
            <View style={styles.tokenCard}>
              ...
              >
                Al finalizar el <Text style={styles.tokenStrong}>mes</Text> la
                cantidad de tus semillas{' '}
                <Text style={styles.tokenStrong}>germinará</Text> de esta
                manera:
              </Text>
            </View>
            ...
            <View style={styles.tokenCard}>
              ...
              >
                ...
                <Text style={styles.tokenStrong}>brote</Text>
              </Text>
            </View>
            ...
            <View style={styles.tokenCard}>
              ...
              >
                ...
                <Text style={styles.tokenStrong}>plantula</Text>
              </Text>
            </View>
            ...
            <View style={styles.tokenCard}>
              ...
              >
                ...
                <Text style={styles.tokenStrong}>flor</Text>
              </Text>
            </View>
            ...
            <View style={styles.tokenCard}>
              ...
              >
                De 0 a 10 semillas <Text style={styles.tokenStrong}>No</Text>{' '}
                alcanza a germinar <Text style={styles.tokenStrong}>nada</Text>{' '}
                😒
              </Text>
            </View>
