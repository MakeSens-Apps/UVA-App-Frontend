/**
 * B12 — ProjectVinculationDoneScreen (placeholder)
...
export function ProjectVinculationDoneScreen({ route }: Props): React.JSX.Element {
  return (
    <View style={styles.container}>
      <Text style={styles.title}>ProjectVinculationDone</Text>
