  ...
  return (
    <ScrollView style={styles.scroll} contentContainerStyle={styles.container}>
      ...
      <Text style={styles.status}>
        fontsLoaded:{' '}
        <Text style={{ color: fontsLoaded ? theme.colors.green[500] : theme.colors.orange[500] }}>
          {String(fontsLoaded)}
        </Text>
      </Text>
      <Text style={styles.status}>
        blue[500]:{' '}
        <Text style={{ color: theme.colors.blue[500] }}>{theme.colors.blue[500]}</Text>
      </Text>
      ...
      {/* B10: BottomSheet */}
      <Pressable style={styles.btn} onPress={() => bottomSheetRef.current?.present()}>
      ...
      <UvaBottomSheet ref={bottomSheetRef} snapPoints={['40%', '70%']}>
        <View style={styles.sheetContent}>
          ...
          <Pressable style={styles.btn} onPress={() => bottomSheetRef.current?.dismiss()}>
      ...
      <Pressable
        style={styles.btn}
        onPress={() => showToast({ message: 'Toast de prueba OK', type: 'success', position: 'bottom' })}
      >
      ...
      <Text style={styles.status}>MoonPhaseIcons: new/crescent/full/declining/eclipse</Text>
      ...
      <Pressable style={styles.btn} onPress={() => navigation.navigate('MoonPhase')}>
