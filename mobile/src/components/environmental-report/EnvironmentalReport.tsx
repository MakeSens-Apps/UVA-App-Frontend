    ...
    <View>
      ...
      <View style={[styles.dataRow, { backgroundColor: bgDay }]}>
        ...
        <View style={[styles.dataCell, styles.cell]}>
          <Text style={styles.dataCellText}>{formatValue(day.day.tempMax)}</Text>
        </View>
        <View style={[styles.dataCell, styles.cell]}>
          <Text style={styles.dataCellText}>{formatValue(day.day.tempMin)}</Text>
        </View>
        <View style={[styles.dataCell, styles.cell]}>
        ...
        <View style={[styles.rainfallCell, styles.cell]}>
          <Text style={styles.rainfallText}>{formatRainfall(day.rainfall)}</Text>
        </View>
      </View>
      ...
      <View style={[styles.dataRow, { backgroundColor: '#EDFEFE' }]}>
        ...
        <View style={[styles.dataCell, styles.cell]}>
          <Text style={styles.dataCellText}>{formatValue(day.night.tempMax)}</Text>
        </View>
        <View style={[styles.dataCell, styles.cell]}>
          <Text style={styles.dataCellText}>{formatValue(day.night.tempMin)}</Text>
        </View>
        <View style={[styles.dataCell, styles.cell]}>
          <Text style={styles.dataCellText}>{formatValue(day.night.humMax)}</Text>
        </View>
        <View style={[styles.dataCell, styles.cell]}>
          <Text style={styles.dataCellText}>{formatValue(day.night.humMin)}</Text>
        </View>
...
export function EnvironmentalReport({ reportData }: Props): React.JSX.Element {
  const firstHalf = EnvironmentalReportService.getFirstHalfDays(reportData.days);
  const secondHalf = EnvironmentalReportService.getSecondHalfDays(reportData.days);
