...
> **Lección de proceso:** el cableado superficial existía (descarga → configColors → ThemeProvider → useTheme) y nos engañó tanto en la auditoría como en la remediación (ambas lo marcaron "ausente"→"falso positivo"). _Que esté cableado ≠ que el valor propague._ Verificar siempre el efecto end-to-end.
