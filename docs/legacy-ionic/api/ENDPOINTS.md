...
```graphql
query MeasurementsByUvaIDAndTs($uvaID: ID!, $ts: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection) {
  measurementsByUvaIDAndTs(uvaID: $uvaID, ts: $ts, sortDirection: $sortDirection) {
    items {
      id
      type
      data
...
```graphql
query UserProgressesByUserIDAndTs($userID: ID!, $ts: ModelStringKeyConditionInput, $sortDirection: ModelSortDirection) {
  userProgressesByUserIDAndTs(userID: $userID, ts: $ts, sortDirection: $sortDirection) {
    items {
      id
      ts
      Seed
